...
function draw() {
  ...
  let newSlices = glitchSlowdown ? 20 : 600;
  let maxOffset = glitchSlowdown ? 80 : 200;
...
function drawButton() {
  ...
  textFont(font);
  textSize(16);
  text(glitchSlowdown ? "RUN FREE" : "THE NUMBER 127", width / 2, height - 43);
}
